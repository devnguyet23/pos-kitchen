...
let ScopeGuard = class ScopeGuard {
    ...
    getRequestedChainId(request) {
        var _a, _b, _c;
        const chainId = ((_a = request.query) === null || _a === void 0 ? void 0 : _a.chainId) || ((_b = request.params) === null || _b === void 0 ? void 0 : _b.chainId) || ((_c = request.body) === null || _c === void 0 ? void 0 : _c.chainId);
        return chainId ? parseInt(chainId, 10) : null;
    }
    getRequestedStoreId(request) {
        var _a, _b, _c;
        const storeId = ((_a = request.query) === null || _a === void 0 ? void 0 : _a.storeId) || ((_b = request.params) === null || _b === void 0 ? void 0 : _b.storeId) || ((_c = request.body) === null || _c === void 0 ? void 0 : _c.storeId);
