...
export default function ReportsCategoriesPage() {
                                                                                ...
                                                                                <table className="min-w-full divide-y divide-gray-200">
                                                                                                    <thead className="bg-gray-50">
                                                                                                                        <tr>
                                                                                                                                            ...
                                                                                                                                            {legend.map(item => (
                                                                                                                                                                <th key={item.categoryId} className="px-4 py-3 text-right text-xs font-medium text-gray-500 uppercase">
                                                                                                                                                                                    <div className="flex items-center justify-end gap-1">
                                                                                                                                                                                                        <div className="w-2 h-2 rounded" style={{ backgroundColor: getCategoryColor(item.categoryId) }} />
